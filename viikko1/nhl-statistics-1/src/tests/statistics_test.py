...
class TestStatistics(unittest.TestCase):
    ...
    def test_palauttaa_topPisteet_oikein(self):
        self.assertEqual(str(self.statistics.top(3, 1)[0]), "Gretzky EDM 35 + 89 = 124")

    def test_palauttaa_topMaalit_oikein(self):
        self.assertEqual(str(self.statistics.top(3, 2)[0]), "Lemieux PIT 45 + 54 = 99") 

    def test_palauttaa_topSyoto_oikein(self):
        self.assertEqual(str(self.statistics.top(3, 3)[0]), "Gretzky EDM 35 + 89 = 124")  
